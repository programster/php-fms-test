...
class Autoloader
{
    ...
    */
     ...
     * 
     * @return Bool result - indicator whether we successfully included the file or not.
     ...
     * 
     * @return String filename - the name of the file that the class should be defined in.
     */
